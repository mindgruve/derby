...
class ImageGDTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConvertFocusPointX()
    {
        ...
        $this->assertEquals(0, $this->sourceFile->convertFocusPointX());

        $this->sourceFile->setFocusPointX(-.5);
        $this->assertEquals(200, $this->sourceFile->convertFocusPointX());

        $this->sourceFile->setFocusPointX(0);
        $this->assertEquals(400, $this->sourceFile->convertFocusPointX());

        $this->sourceFile->setFocusPointX(.5);
        $this->assertEquals(600, $this->sourceFile->convertFocusPointX());

        $this->sourceFile->setFocusPointX(1);
        $this->assertEquals(800, $this->sourceFile->convertFocusPointX());
    }
    ...
    public function testGDConvertFocusPointY()
    {
        ...
        $this->assertEquals(866, $this->sourceFile->convertFocusPointY());

        $this->sourceFile->setFocusPointY(-.5);
        $this->assertEquals(649.5, $this->sourceFile->convertFocusPointY());

        $this->sourceFile->setFocusPointY(0);
        $this->assertEquals(433, $this->sourceFile->convertFocusPointY());

        $this->sourceFile->setFocusPointY(.5);
        $this->assertEquals(216.5, $this->sourceFile->convertFocusPointY());

        $this->sourceFile->setFocusPointY(1);
        $this->assertEquals(0, $this->sourceFile->convertFocusPointY());
    }


    public function testGdResizeWithFocusPointCenter()
    {
        if (!extension_loaded('gd')) {
            return;
        }
        ...
        $sourceKey = 'test-800x866.jpg';
        $targetKey = 'gd-resize-with-focuspoint-vCenter-'.$sourceKey;
        $this->setUpImages($sourceKey, $targetKey);

        $this->sourceFile->setFocusPointX(0);
        $this->sourceFile->setFocusPointY(0);
        $this->sourceFile->resize(150, 150, Image::THUMBNAIL_OUTBOUND)->save($this->targetFile);
    }


    public function testGdResizeWithFocusPointNorth()
    {
        if (!extension_loaded('gd')) {
            return;
        }
    ...
    public function testGdResizeWithFocusPointSouth()
    {
        if (!extension_loaded('gd')) {
            return;
        }
        ...
        $sourceKey = 'test-800x866.jpg';
        $targetKey = 'gd-resize-with-focuspoint-vSOUTH-'.$sourceKey;
        $this->setUpImages($sourceKey, $targetKey);
    ...
    public function testGdResizeWithFocusPointEast()
    {
        if (!extension_loaded('gd')) {
            return;
        }
        ...
        $sourceKey = 'test-800x866.jpg';
        $targetKey = 'gd-resize-with-focuspoint-vEAST-'.$sourceKey;
        $this->setUpImages($sourceKey, $targetKey);
    ...
    public function testGdResizeWithFocusPointWEST()
    {
        if (!extension_loaded('gd')) {
            return;
        }
        ...
        $sourceKey = 'test-800x866.jpg';
        $targetKey = 'gd-resize-with-focuspoint-vWEST-'.$sourceKey;
        $this->setUpImages($sourceKey, $targetKey);
